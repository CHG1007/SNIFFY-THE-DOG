...
const GameHistoryRow = ({ date, role, result, team, onReport }) => {
  ...
  return (
    <div className="grid grid-cols-[1.2fr_1.8fr_1fr_1fr_1.5fr] items-center px-8 py-4 bg-[#FFFFFF]/40 rounded-[10px] hover:bg-white/25 transition-all shadow-inner">
      ...
      <div className="text-white text-xl font-bold text-center">{team}</div>

      <div className="flex justify-center">
        <button 
          onClick={onReport}
          className="w-full max-w-[150px] py-2.5 bg-[#e2e2e2] hover:bg-white text-black font-black rounded-xl transition-all shadow-lg active:scale-95"
        >
          REPORT
        </button>
      </div>
